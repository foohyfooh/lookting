 ...
 * @author Jonathan
 */
public class ComingEvents extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Event> comingEvents = query.setParameter("startDate", Utils.getCurrentDate()).getResultList();
            JSONArray jsonArray  = new JSONArray(comingEvents);
            jsonArray.write(out);
        } finally {            
            out.close();
        }
